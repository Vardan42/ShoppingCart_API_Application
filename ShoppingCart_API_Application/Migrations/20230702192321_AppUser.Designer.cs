...
namespace ShoppingCart_API_Application.Migrations
{
    ...
    [Migration("20230702192321_AppUser")]
            ...
            modelBuilder.Entity("ShoppingCart_API_Application.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 7, 2, 12, 23, 21, 302, DateTimeKind.Local).AddTicks(8576),
                            ...
                            Rate = 200.0,
                            Sqft = 500,
                            UpdatedDate = new DateTime(2023, 7, 2, 12, 23, 21, 302, DateTimeKind.Local).AddTicks(8641)
                        });
                });
