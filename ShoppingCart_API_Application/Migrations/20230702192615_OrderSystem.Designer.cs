...
namespace ShoppingCart_API_Application.Migrations
{
    ...
    [Migration("20230702192615_OrderSystem")]
            ...
            modelBuilder.Entity("ShoppingCart_API_Application.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 7, 2, 12, 26, 15, 522, DateTimeKind.Local).AddTicks(5975),
                            ...
                            Rate = 200.0,
                            Sqft = 500,
                            UpdatedDate = new DateTime(2023, 7, 2, 12, 26, 15, 522, DateTimeKind.Local).AddTicks(6035)
                        });
                });
