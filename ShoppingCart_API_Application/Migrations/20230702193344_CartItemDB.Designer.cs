...
namespace ShoppingCart_API_Application.Migrations
{
    ...
    [Migration("20230702193344_CartItemDB")]
    partial class CartItemDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShoppingCart_API_Application.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 7, 2, 12, 33, 43, 809, DateTimeKind.Local).AddTicks(6523),
                            ...
                            Rate = 200.0,
                            Sqft = 500,
                            UpdatedDate = new DateTime(2023, 7, 2, 12, 33, 43, 809, DateTimeKind.Local).AddTicks(6583)
                        });
                });
